...
@section("content")
        <div class="col-sm-8">
            <blockquote>
                <p>
                    {{--<img src="/storage/9f0b0809fd136c389c20f949baae3957/iBkvipBCiX6cHitZSdTaXydpen5PBiul7yYCc88O.jpeg" alt="" class="img-rounded" style="border-radius:500px; height: 40px"> --}}
                    {{$user->name}}
                </p>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="tab_1">
                        ...
                        <div class="blog-post" style="margin-top: 30px">
                            ...
                            <p class=""><a href="/posts/{{$post->user->id}}" >{{$post->user->title}}</a></p>
